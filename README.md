...
- **Progressive Difficulty** — Levels get harder as your score increases
...
| Icon | Name | Effect |
|------|------|--------|
| **R** | Rapid Fire | Faster shooting rate |
| **S** | Spread Shot | Triple bullet spread |
...
- **JavaScript** — Game loop, physics, collision detection, and state management
